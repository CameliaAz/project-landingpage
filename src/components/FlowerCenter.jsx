export default function FlowerCenter() {
  return (
    <div className="absolute top-12 md:top-20 left-0 w-full flex justify-center z-10 pointer-events-none">
      <div className="relative w-full max-w-7xl h-0">
        ...
        <img
          ...
          className="absolute -top-8 xs:-top-2 sm:-top-20 md:-top-80 right-1/2 
        ...
        <img
          ...
          className="absolute -top-8 xs:-top-2 sm:-top-20 md:-top-80 left-1/2 
        ...
        <img
          ...
          alt="center flower"
          className="absolute top-10 xs:top-6 md:top-10 left-1/2 -translate-x-1/2 
